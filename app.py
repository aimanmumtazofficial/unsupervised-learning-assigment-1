...
uploaded_file = st.file_uploader(
    "📂  Upload the Online Retail CSV file to begin",
    type=["csv"],
...
if uploaded_file is not None:
    ...
    st.markdown("<br>", unsafe_allow_html=True)
    st.warning("⬆️  Please upload the **Online Retail CSV** file using the uploader above to begin the analysis.")
    st.info("""
    **How to get the dataset:**
    1. Visit the UCI Machine Learning Repository
    2. Search for 'Online Retail Dataset'
    3. Download 'Online Retail.xlsx' and save as CSV
    OR download directly from: https://archive.ics.uci.edu/ml/datasets/Online+Retail
    """)